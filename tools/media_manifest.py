...
def render_plan_md(model: dict) -> str:
    ...
    P("## 4. Kötegek")
    P("")
    P("Egy asset **pontosan egy** kötegbe kerül, és a köteg neve azt mondja meg,")
    P("melyik az **utolsó** kapuja — nem azt, hogy csak arra vár. Ha egy tételen")
    P("több kapu ül, mindegyiknek le kell zárulnia; a „Kapuk” oszlop ezért mindig")
