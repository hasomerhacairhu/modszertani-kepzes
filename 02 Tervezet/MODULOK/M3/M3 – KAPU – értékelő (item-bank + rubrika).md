...
← Vissza a modul-hubhoz: **[M3 – „Kvuca, red flag, felelősség” – Csoportdinamika, korosztályok és gyerekvédelem](./M3%20–%20„Kvuca,%20red%20flag,%20felelősség”%20–%20Csoportdinamika,%20korosztályok%20és%20gyerekvédelem%20.md)**
...
**Mit kapuz élesen ez a kapu, és mit nem?** A modul három kimeneti kompetenciája közül (Tuckman-szakaszok, 4 someres kvuca-profil, gyerekvédelem & red flag) **éles, küszöbös méréssel csak a harmadikat** – a gyerekvédelmi minimumot – kapuzzuk; az item-bank (1–12) és a rubrika **szándékosan kizárólag** ezt méri. A **Tuckman- és a kvuca-profil-kompetencia formatív / completion-alapú**: az M3.1–M3.2 beágyazott H5P-kvízei (Drag&Drop, Matching, minikvíz) és az M3.A peula gyakoroltatják, és az **activity completion** fedi le – ezek nem buknak külön a kapun. Ez nem hiányosság, hanem a program **kapu-filozófiájával** összhangban álló döntés: „tisztán kvíz-kapu csak ott éles, ahol a biztonsági minimum-tudás konvergens ellenőrzése indokolt – ez gyakorlatilag az M3 gyerekvédelmi reflexei” (lásd Program terv §5). Így a program-mátrix három kompetenciát ígér, a kapu szándékosan egyet kapuz élesen, a másik kettőt completion-szinten – ez a rés **dokumentált, nem rejtett**.
...
- **Kötelező kritikus itemek: 2, 4, 7, 9.** Ha ezek bármelyike rossz → **nem átmenő**, akkor is, ha az összpont ≥ 10 (a Moodle-ban ez „minden kritikus item helyes ÉS összpont ≥ 80%” feltételként, vagy mentori utóellenőrzéssel kezelhető; ha a Moodle nem tud item-szintű feltételt, a kritikus itemek súlyozhatók 2 pontra és a küszöb arányosan emelhető – a stáb döntése, dokumentáld).
- **Miért épp ez a négy a kritikus, és nem pl. a madrich–chanich párkapcsolat (ITEM 10) vagy az online zaklatás (ITEM 11)?** A kötelező négy item az a **konvergens, eljárásban is egyedi reflexnégyes**, amit elrontva a tanuló *aktívan árthat* (titoktartást ígér → 2; halaszt akut önveszélynél → 4; figyelmezteti a gyanúsított felnőttet → 7; nyomoz a meghallgatás helyett → 9). Az ITEM 10 (madrich–chanich párkapcsolat) és az ITEM 11 (online zaklatás) **ugyanúgy súlyos red flag** (ld. §1.1), és a helyes lépésük – „jelezz a felelősnek, ne maradj egyedül” – **megegyezik** az ITEM 3/5/12 általános jelzési reflexével, amelyeket az összpont-küszöb (≥ 10/12) már lefed. Vagyis aki ITEM 10/11-et téveszt, de a négy kritikus reflexet és az összpontot hozza, az **a felismert red flaget akkor is a felelőshöz vinné** – nem a do-not-tip-off / nem-nyomoz típusú, visszafordíthatatlan hibába esik. Ezért ITEM 10/11 a **lefedettségben** kötelező (szerepel a bankban, méri a rubrika R1 sora is), a **hard-blokkoló** kritikus körben viszont szándékosan nem – ha a stáb a helyi protokoll alapján szigorítani akar, ITEM 10 bevonható ötödik kritikus itemként (5/12 még védhető arány a 12-item mellett), de ez **a gyerekvédelmi felelős döntése** a véglegesítéskor.
...
- A — Feledékenység normál kamasz-viselkedés, nem biztonsági jel.
...
- A — Veszélyes: nem tudhatod előre, mi jön; lehet, hogy kötelező bevonnod egy felnőttet. A titoktartás-ígéret csapdába visz.
...
**Miért ez a jó / miért rossz a többi:**
- ✅ **B** — A jelzés a someres struktúrán belül felfelé megy: mentor / gyerekvédelmi felelős / vezető. Ők döntenek a külső jelzésről. Te egy láncszem vagy, nem maradsz egyedül.
...
**Tanulói feedback:** „A jelzés a **felelős felnőtt felé** megy (mentor / gyerekvédelmi felelős / vezető), nem a kvucának, nem közvetlenül a szülőnek. Nem te nyomozol és nem te döntesz egyedül.”
...
### ITEM 5 — „Egyedül megoldom” csapda
...
**Miért ez a jó / miért rossz a többi:**
- ✅ **B** — A bizalom megtartása **nem** azt jelenti, hogy egyedül cipeled. A madrich láncszem, nem terapeuta; a felelős bevonása a chanich érdeke.
- A — Az „egyedül megoldom” épp a leggyakoribb és legkockázatosabb hiba; nem vagy terapeuta vagy nyomozó.
...
- B) Privátban kérsz tőle képet magáról, mert kíváncsi vagy, hogy néz ki most.
...
- D) A személyes profilodról privátban küldözgetsz neki éjszakai üzeneteket, hogy közelebb kerüljetek.
...
**Tanulói feedback:** „Ha a gyanú **egy felnőttre/kollégára** vonatkozik: **ne beszéld meg vele, ne konfrontáld** – közvetlenül a gyerekvédelmi felelősnek / vezetőnek jelezz. Ha épp a felelős a gyanúsított, egy másik, nem érintett vezetőnek.”
...
**Miért ez a jó / miért rossz a többi:**
- ✅ **C** — A madrich–chanich párkapcsolat **elfogadhatatlan határátlépés, önmagában súlyos red flag**; itt a felelős bevonása kötelező (és felnőtt-gyanúként kezelendő → ne a kvucának, hanem a felelősnek).
- A — A „magánügy / kölcsönös beleegyezés” érv itt nem érvényes: a felelősség- és hatalmi különbség miatt elfogadhatatlan.
...
- B) **Jelzek a mentoromnak / felelősnek**, mert bizonytalanságban is biztonságosabb kérdezni, mint egyedül cipelni – ha kiderül, hogy nem red flag, **akkor sem baj, hogy szóltam**. ✅
- C) Addig figyelek és gyűjtök bizonyítékot egyedül, amíg 100%-ig biztos nem leszek.
...
> **Modulproduktum (M3.4 SLIDE 7):** rövid **helyzetleírás** (max. 8–10 mondat), amelyben a tanuló megnevez(i): hol játszódik + kvuca-típus, mi történik, **legalább egy red flag**, **a felelős madrich első lépése** (mit mond / mit NEM ígér), és **kit von be**.
...
- **Átmenő (pass):** mind a 4 sor legalább **Alapszint (1)**, **ÉS** az **R2 (titoktartás)** és **R4 (nem nyomoz / nem konfrontál)** sor **blokkoló** → ha bármelyik 0, a beadvány **nem mehet át** a többi sortól függetlenül (gyerekvédelmi tét).
...
- **R3 hiány (nincs konkrét felnőtt):** „A red flaget jól látod, de a leírásból hiányzik, **kit** vonna be a madrich. Nevezd meg konkrétan: mentor / gyerekvédelmi felelős / vezető. (Vissza: M3.3 SLIDE 2.)”
...
## 3. Mentor-eszkaláció (2 sikertelen próba után)

A mentor a learning analytics alapján nézze át, **mely red flag típust** nem ismeri fel a tanuló (kvíz item-szintű adat), és melyik rubrikasor gyenge. Tipikus fókuszok: **titoktartás határa (item 2, 8 / R2)**, **akut önveszély (item 4)**, **felnőtt-gyanú / do-not-tip-off (item 7 / R4)**, **meghallgatás vs. nyomozás (item 9 / R4)**. A beszélgetés **támogató, nem büntető** – a cél a biztonságos szemlélet megszilárdítása, nem a „megbuktatás”.
