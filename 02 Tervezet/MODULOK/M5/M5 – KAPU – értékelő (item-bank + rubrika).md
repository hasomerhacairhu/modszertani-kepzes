...
## 0. Kapu-meta – mit, mivel, milyen küszöbbel mérünk
...
| Item | Fogalomcsalád | Szint |
|---|---|---|
| Q1 | Formális/nonformális/informális | Felismerő |
| Q2 | Formális/nonformális/informális | Alkalmazás (besorolás) |
| Q3 | Formális/nonformális/informális | Alkalmazás (határeset: nonformális vs. informális) |
| Q4 | Formális/nonformális/informális | Felismerő (megkülönböztető jegy) |
| Q5 | Feladat→cél→kvuca→módszer lánc | Felismerő (sorrend) |
...
## 1. Item-bank – Fogalomcsalád 1: formális / nonformális / informális
...
## 2. Item-bank – Fogalomcsalád 2: feladat → cél → kvuca → módszer (NÉGYTAGÚ lánc)

> ⚠️ **A lánc négytagú:** *feladat → cél → kvuca → módszer.* A helyes válaszok mind ezt a négyelemű, ebben a sorrendben haladó láncot tükrözik.
...
### Q8 – Alkalmazás (cél–módszer illeszkedés)
...
**Distraktor-indokok:**
- A) beszél a készségről, de nem gyakoroltatja – formális logika, nem illik a célhoz.
...
| **R4** | **Tanulástan-elem valódisága** (kritikus sor) – a 4. mező konkrét cselekvést ír le, nem csak a fogalom nevét ismétli | Csak a **címke** szerepel: „spacing”, „retrieval”, „gyakorlás” – cselekvés nélkül; vagy a megnevezett elem **nincs összhangban** a módszerrel (pl. „spacing”, de a peula egyszeri és nem tér vissza). | A tanulástan-mező **konkrét cselekvést** ír le, ami valóban az adott fogalom: „következő pénteken rákérdezek, mire emlékeznek” = visszahívás; „a játék 3 héten át rövid blokkokban visszatér” = spacing. | Legalább 2 sorban megjelenik **2 különböző** tanulástan-elem, mindegyik konkrét cselekvéssel; és/vagy egy soron belül **több elem tudatos kombinációja** (pl. gyakorlás + visszahívás + spacing egy tervben), helyesen használva. |

**Mintamondatok az értékelőnek (kalibrációhoz):**
- **R4 Hiányos:** „Tanulástan: spacing.” → csak címke, nincs cselekvés → vissza.
- **R4 Alapszint:** „Tanulástan: a következő két pénteken 5 percre újra elővesszük ugyanezt a játékot.” → konkrét, valódi spacing → átmegy.
