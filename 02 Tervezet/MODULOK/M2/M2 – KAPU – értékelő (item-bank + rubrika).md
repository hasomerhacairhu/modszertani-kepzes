...
## 0. Kapu-fejléc (a stábnak, egy pillantásra)
...
| **Küszöb (soft gate)** | **Beadáshoz:** a self-check checklist mind a pontján legyen pipa (a tanuló saját ellenőrzése). **A mentor felé:** a rubrika **mind a 4 során legalább „1 – elindult” szint** ÉS **legalább 1 soron „2 – kész”** szint. Ez NEM ponthatáros vizsga: aki ez alatt van, **nem bukik**, hanem **fejlesztő visszajelzést + M2.F (Study Lab) ajánlást** kap, és újra beadhat. |
...
> Tedd ki magadnak ezt a listát, mielőtt feltöltöd az identitás-jegyzetedet. Ez **nem vizsga** – arra jó, hogy te magad lásd, tényleg összeállt-e a jegyzeted, vagy maradt benne valami félkész. Akkor jó a beadásra, ha **mindegyikre tudsz pipát tenni**. Ha valamelyiknél elakadsz, az pont egy jó pont, amin még dolgozhatsz (vagy amit M2.F-ben átnézhetsz).
...
> Ha mind a 10-re pipát tettél: **add be!** Ha 1–2 helyen elakadtál, az nem baj – jelöld magadnak, vagy hozd el M2.F-re (Study Lab), és ott közösen átnézzük.
...
A jegyzetbe „1 someres értéket” kell írnod. Az alábbiak közül melyik **valódi érték**, amit a viselkedéseddel következetesen meg tudsz mutatni?

- A) „Jó fej, laza madrich leszek, akit szeretnek.”
- B) „Egyenlőség: a csendesebbeket is bevonom, nem csak a hangosak kapnak szót.” ✅
- C) „Igyekszem mindig jó hangulatot csinálni a peulán.”
- D) „Az a fontos, hogy a chanichok jól érezzék magukat velem.”

> **Feedback:** ✅ **B.** Az érték olyan iránytű, ami **konkrét döntésekben és viselkedésben** megjelenik (kit szólítasz meg, hogyan osztod a szót). Az A, C, D inkább **hangulat vagy népszerűség** – kedves célok, de nem mutatnak meg egy értéket, és nem fordíthatók egyértelmű, megfigyelhető viselkedésre. A jegyzetedben olyan értéket válassz, amihez tudsz **konkrét viselkedést** írni.

### Item 2 – Mit olvas le rólad a chanich? (M2.1, M2.2, M2.3)

Egy chanich egy egész peulán át figyel téged. **Miből** fogja leginkább leszűrni, mik az értékeid?

- A) Abból, ahogy a peula elején elmondod neki, mik a someres értékeid.
- B) Abból, hogy milyen hosszan és okosan írsz a képzős kérdőívekben.
- C) Abból, **amit a viselkedéseden lát**: hogyan döntesz, kit vonsz be, hogyan reagálsz egy konfliktusra. ✅
- D) Abból, hogy melyik pillérhez érzed magad a legközelebb.

> **Feedback:** ✅ **C.** Ez a **dugma ishit** lényege: a chanichok nem a magyarázatból, hanem a **látható viselkedésedből** tanulnak. Az A (magyarázat) és a D (belső érzés) nem látszik kívülről; a B-t a chanich nem is látja. A jegyzeted ezért a 4. self-check pontnál azt kéri: írd le, **mit olvasna le rólad** egy figyelő chanich.
...
- A) „Nagyon felelős ember vagyok, ez mindig is fontos volt nekem.”
- B) „Szeretném, ha a kvucám érezné, hogy felelős vagyok.”
- C) „A felelősség az egyik vezető someres értékem.”
- D) „Ha elvállalok egy programrészt, időben felkészülök, és ha mégsem megy, **előre szólok**, nem az utolsó pillanatban.” ✅

> **Feedback:** ✅ **D.** Ez **megfigyelhető**: egy kívülálló meg tudná mondani, megtörtént-e (felkészültél? előre szóltál?). Az A, B, C csak **kimondja az értéket vagy a szándékot**, de nem mutat konkrét, látható cselekvést. A rubrika 2. sora pontosan ezt nézi a jegyzetedben.
...
- A) „Idén jó madrich szeretnék lenni.”
- B) „Mindig tisztelni fogom a chanichokat.”
- C) „Idén minden peula körében **név szerint megszólítom a két-három legcsendesebb chanichot is**, hogy az egyenlőség ne csak szó legyen.” ✅
- D) „A közösség nagyon fontos érték a Somerben.”

> **Feedback:** ✅ **C.** Konkrét (mit), megfigyelhető (megtörtént-e), és **idei / a saját kvucádban elkezdhető**. Az A és B túl általános („jó”, „mindig tisztelni”), a D pedig egy fogalom kimondása, nem vállalás. A jegyzeted záró mondata legyen ennyire konkrét.

### Item 7 – Identitás-körök madrich-szerepben (M2.1)

Az identitás-jegyzeted 1. blokkjába az identitás-köreidet írod. Melyik megfogalmazás mutatja meg igazán, **hogyan hat egy köröd a madrich-viselkedésedre** (ahogy M2.1 kéri)?

- A) „Someres vagyok, ez a közegem gyerekkorom óta.”
- B) „A családom, a zsidóságom és a Somer mind fontos kör nekem.”
- C) „A someres körömből hozom, hogy **vitában tudatosan mindenkinek adok szót, a csendesebbeket is név szerint behívom**.” ✅
- D) „Több identitás-köröm van, és ezek mind a részeim.”

> **Feedback:** ✅ **C.** Itt nem csak megnevezel egy kört, hanem **összekötöd egy konkrét madrich-viselkedéssel** – pont ezt mutatja M2.1: a köreidet „magaddal viszed a kvucába”, és a chanichok a viselkedésedből olvassák le őket. Az A, B, D csak **felsorol vagy címkéz** (kör neve, „fontos”, „a részeim”), de nem derül ki, mi *látszik* belőle a kvucádon. A jegyzeted R1 sorához mindegyik körhöz írj egy ilyen „hogyan hat rám” mondatot.

### Item 8 – Privát – személyes – szakmai (M2.4)

M2.4 szerint nem minden témának ugyanott a helye. Egy chanich a peula szünetében megkérdezi, neked is volt-e már olyan, hogy nehéz volt iskolába menni. Melyik reakció felel meg a **„személyes”** szintnek (nem privát, nem szakmai)?

- A) Részletesen elmeséled a saját, most is zajló szorongásodat, és tőle kérsz megerősítést, hogy jól kezeled.
- B) „Ez nem tartozik rád” – elzárkózol, és témát váltasz.
- C) Röviden megosztod, hogy **veled is előfordult már hasonló, és így emberként kapcsolódsz**, de nem terheled rá a saját érzelmi feldolgozásodat. ✅
- D) Nem reagálsz, és rögtön jelented a mentornak, hogy a chanich a magánéletedről kérdezett.

> **Feedback:** ✅ **C.** Ez a **„személyes”** szint M2.4-ből: megoszthatsz valamit, hogy emberinek lássanak és kapcsolódni tudjatok, **de nem támaszkodsz érzelmileg a chanichokra**. Az A átcsúszik a **privát/önterhelő** sávba (a saját aktuális krízised nem a chanichra tartozik), a B fölöslegesen elzárkózik egy ártalmatlan kérdéstől, a D pedig egy hétköznapi kérdést kezel gyerekvédelmi jelzésként. A jegyzeted határ-részéhez (R4) ez a három sáv ad keretet.
...
- A) Mert így a chanichok látják, hogy a madrich gyenge, és nem érdemes rá számítani.
- B) Mert a saját viselkedéseddel **modellezed, hogy magunkra vigyázni és segítséget kérni rendben van** – ezt tanulják el tőled. ✅
- C) Mert a szabályok betartása a fő cél, a chanichokkal való kapcsolat másodlagos.
- D) Mert ha határt tartasz, akkor sosem kell felnőttet bevonnod egy nehéz helyzetbe.

> **Feedback:** ✅ **B.** M2.4 szerint „azzal is **személyes példát mutatsz**, hogy időben segítséget kérsz, és vigyázol a saját határaidra” – a chanichok ebből tanulják meg, hogyan vigyázzanak ők is magukra. Az A félreérti (a határtartás nem gyengeség, hanem felelősség), a C szembeállítja a keretet a kapcsolattal (pedig a kettő együtt jár), a D pedig épp az ellenkezőjét állítja annak, amit M2.4 tanít: a felnőtt bevonása sokszor **kötelező** első lépés.
...
1) AZ IDENTITÁS-KÖREIM  (M2.1)
   ...
   • Somer / tnuá / kvuca – __________________________________________
   • (Egyéb köröm: iskola / barátok / online / aktivizmus) – __________
   → Amit ebből egy chanich is LÁT rajtam: ___________________________

2) AZ ÉRTÉKEM, AMI IRÁNYTŰ  (M2.2)
   Az 1 someres érték, amiben idén tudatosan példát mutatok:
   ÉRTÉK: __________________________  (pl. egyenlőség / közösség / felelősség)
   Ezt KONKRÉT VISELKEDÉSBEN így látja meg a kvucám:
