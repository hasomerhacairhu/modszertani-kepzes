...
- [ ] **G1 Gyermekvédelem:** kijelölt felelős, helyi jelzési/escalation protokoll, alternatív út összeférhetetlenség esetére, M3 és kapcsolódó biztonsági tartalmak szakértői aláírása. Lásd `Gyermekvédelem – release gate.md`.
...
- [ ] **G6 Terminológia és korosztály:** a helyi Somer megerősítette a 2026-os hivatalos alakokat és a 3/4 kvuca-architektúrát; a glosszárium és tananyag ennek megfelelő.
- [ ] **G7 Release regression:** `tools/content_integrity.py` 0 ERROR; link-check 0 broken local link; nincs duplikált hivatalos fájl.
