...
### mazkirut (מזכירות)
- **Jelentés:** titkárság / vezetőtestület.
- **Státusz:** **jelenleg NEM szerepel** a tananyagban (0 előfordulás). Ha bekerül, ezzel a jelentéssel vezesd be, a helyi Somer szakértővel egyeztetve.
...
4. **performing** – „működés”
5. **adjourning** – lezárás / szétválás (a csoport feloszlása)
...
## 3. Írásmód-szabályok (lektoroknak – fontos!)

1. **A magyar-fonetikus átírások SZÁNDÉKOSAK.** `kvuca`, `Somer`, `peula`, `Zmán Kvucá` a magyar fonetika szerinti, belül teljesen konzisztens alakok. **Ne** „javítsd” a nemzetközi standardra (kvutza, shomer). Ezek nem hibák.
