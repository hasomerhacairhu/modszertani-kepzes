...
- **Sablon-konzisztencia (modalitás):** a #3 modalitás-pilot (M5.3 Dialog Cards, M2.3 Branching) beépült; **a Z.4 NEM Documentation Toolra épül** — a H5P Documentation Tool nem támogatja a content state savinget, ezért a Z.4 kánoni futtatókörnyezete **Moodle Assignment** (lásd `LMS – H5P runtime acceptance.md`); a teljes terv a `[[modality-variety-plan]]` memóriában.
